...
var file_api_p2p_proto_rawDesc = []byte{
	...
	0x02, 0x32, 0x86, 0x03, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72, 0x54, 0x6f, 0x50, 0x65, 0x65, 0x72,
	...
	,
}
...
var file_api_p2p_proto_depIdxs = []int32{
	...
	8, // 5: p2p.api.PeerToPeer.EventRelay:input_type -> p2p.api.Event
	5, // 6: p2p.api.PeerToPeer.Health:input_type -> p2p.api.Empty
	2, // 7: p2p.api.PeerToPeer.Connect:output_type -> p2p.api.ConnectResponse
	4, // 8: p2p.api.PeerToPeer.Disconnect:output_type -> p2p.api.DisconnectResponse
	7, // 9: p2p.api.PeerToPeer.ProduceEvent:output_type -> p2p.api.EventResponse
	7, // 10: p2p.api.PeerToPeer.ProduceEventStream:output_type -> p2p.api.EventResponse
	5, // 11: p2p.api.PeerToPeer.EventRelay:output_type -> p2p.api.Empty
	9, // 12: p2p.api.PeerToPeer.Health:output_type -> p2p.api.HealthResponse
